          ...
          <Card className="bg-card/80 backdrop-blur-sm border-border/50">
            ...
            <CardContent className="space-y-6 text-muted-foreground">
              ...
              <div>
                ...
                <p>To participate in tournaments, you must create an account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account. You must be at least 18 years old to create an account.</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-xl font-bold text-accent mb-2">4. Payments and Winnings</h3>
                <p>All entry fees are processed through our designated payment gateways. Winnings will be distributed to the UPI ID provided during registration. BattleBucks is not responsible for incorrect payment information provided by the user.</p>
              </div>
              <div>
