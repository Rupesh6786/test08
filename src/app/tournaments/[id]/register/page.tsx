          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <Card className="bg-card/80 backdrop-blur-sm border-border/50">
                <CardHeader>
                  <CardTitle className="text-2xl font-headline text-accent">Registration</CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="font-bold text-lg mb-4">1. Scan & Pay Entry Fee</h3>
                     ...
                     <div>
                        <h3 className="font-bold text-lg mb-4">2. Submit Your Details</h3>
                        <MatchRegistrationForm tournamentTitle={tournament.title} tournamentId={tournament.id} />
                    </div>
                </CardContent>
              </Card>
            </div>
