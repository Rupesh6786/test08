          ...
          <Card className="bg-card/80 backdrop-blur-sm border-border/50">
            ...
            <CardContent className="space-y-6 text-muted-foreground">
              ...
              <div>
                ...
                <p>In the unlikely event that a tournament is canceled by BattleBucks, all registered players will receive a full refund of their entry fee. Refunds will be processed to the original payment method within 5-7 business days.</p>
              </div>
              <div>
